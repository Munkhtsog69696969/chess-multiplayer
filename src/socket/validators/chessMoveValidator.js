...
const isValidMove = (action, boardState, isWhite) => {
    ...
    const whitePieces = [
        chessActions_1.ChessPiece.WhiteKing,
        chessActions_1.ChessPiece.WhiteQueen,
        chessActions_1.ChessPiece.WhiteRook,
        chessActions_1.ChessPiece.WhiteKnight,
        chessActions_1.ChessPiece.WhiteBishop,
        chessActions_1.ChessPiece.WhitePawn
    ];
    ...
    switch (chess_piece) {
        case chessActions_1.ChessPiece.WhitePawn:
        case chessActions_1.ChessPiece.BlackPawn:
            return validatePawnMove(from, to, boardState, isWhite);
        case chessActions_1.ChessPiece.WhiteRook:
        case chessActions_1.ChessPiece.BlackRook:
            return validateRookMove(from, to, boardState, isWhite);
        case chessActions_1.ChessPiece.WhiteKnight:
        case chessActions_1.ChessPiece.BlackKnight:
            return validateKnightMove(from, to, boardState, isWhite);
        case chessActions_1.ChessPiece.WhiteBishop:
        case chessActions_1.ChessPiece.BlackBishop:
            return validateBishopMove(from, to, boardState, isWhite);
        case chessActions_1.ChessPiece.WhiteQueen:
        case chessActions_1.ChessPiece.BlackQueen:
            return validateQueenMove(from, to, boardState, isWhite);
        case chessActions_1.ChessPiece.WhiteKing:
        case chessActions_1.ChessPiece.BlackKing:
...
const validatePawnMove = (from, to, boardState, isWhite) => {
...
const validateRookMove = (from, to, boardState, isWhite) => {
...
const validateKnightMove = (from, to, boardState, isWhite) => {
...
const validateBishopMove = (from, to, boardState, isWhite) => {
...
const validateQueenMove = (from, to, boardState, isWhite) => {
...
const validateKingMove = (from, to, boardState, isWhite) => {
